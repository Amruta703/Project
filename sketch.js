...
function draw() {
  ...
  hero.x = World.mouseX;
   ...
   if(herobGroup.y > 400|| herob1Group.y > 400||herob2Group.y > 400 || herob3Group.y > 400 || herob4Group.y > 400){
    ...
    if(herobGroup.isTouching(herofirecharge)){
...
function createherob() {
  ...
  var herobrien = createSprite(Math.round(random(50,50),40, 10, 10));
  herobrien.addImage("villan",herobImage);
  herobrien.scale=0.12;
  herobrien.velocityY = 3;
...
function createherob1() {
  if (World.frameCount % 200 == 0) {
  var herobrien1 = createSprite(Math.round(random(50,50),40, 10, 10));
...
function createherob2() {
  ...
  if (World.frameCount % 200 == 0) {
  var herobrien2 = createSprite(Math.round(random(50,50),40, 10, 10));
...
function createherob3() {
  if (World.frameCount % 200 == 0) {
  var herobrien3= createSprite(Math.round(random(50,50),40, 10, 10));
...
function createherob4() {
  if (World.frameCount % 200 == 0) {
  var herobrien4 = createSprite(Math.round(random(50,50),40, 10, 10));
